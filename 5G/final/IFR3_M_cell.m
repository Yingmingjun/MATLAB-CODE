function IFR3_M_cell(~)
% show
clear
clc
disp('----------------------------------------------------------------------------')
disp('--------------------------This is the Final Project-------------------------')
disp('-------------This code is made for IFR3 for M-cell network-------------')
...
%                 end
        ...
        fprintf('For SNR = %gdB, Average network capacity with IFR3 is %g\n',snr_dB(m),Ave_cap_net(m));
    end
    fprintf('----------------------------------------------------------------------------------------\n');
%     (center)+IFR3(edge)
    switch M
        case 24
            ...
            plot(snr_dB,Ave_cap_net, 'm>-','linewidth',1.2);
            hold on
