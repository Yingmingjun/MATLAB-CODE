function IFR1_M_cell(~)
% show
clear
clc
disp('----------------------------------------------------------------------------')
disp('--------------------------This is the Final Project-------------------------')
disp('-------------This code is made for IFR1 for M-cell network-------------')
...
%     (center)+IFR3(edge)
    switch M
        case 24
            ...
            plot(snr_dB,Ave_cap_net, 'co-','linewidth',1.2);
            hold on

            
        case 0.4
            plot(snr_dB,Ave_cap_net.*10, 'b^-','linewidth',1.2);
            
        case 0.6
            plot(snr_dB,Ave_cap_net.*10, 'ms-','linewidth',1.2);
            
        case 0.8
            plot(snr_dB,Ave_cap_net.*10, 'g*-','linewidth',1.2);
            
        case 1
            plot(snr_dB,Ave_cap_net, 'bx-','linewidth',1.2);
            hold on
